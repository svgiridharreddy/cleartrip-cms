        ...
        if (type == "columns") {
            ...
            columns.map(col => {
                if (col === "Domain-Section-Language") {
                    ...
                    let mapFields = { title: "Title", heading: "H1 tag", h1Tag: "H1 tag", keyword: "Keywords", keywords: "Keywords", description: "Description", faq_object: "Faq data", reviews_object: "Reviews", content: "Content",content_tabs_data:"Content tabs data" }
